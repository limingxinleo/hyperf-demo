...
class DES
{
     ...
     * @throws \Exception
     */
    function __construct($des_key = 'vbg64d87f09a1843c6579aa47e614sdf7e089738187c791ab9db2fff0530fa97fb57e5ff8222c3e360521d1f6429fa8f')
    {
        if (!empty($des_key))
        {
            $this->encrypt = true;
            $this->des = new SwooleDES(substr($des_key, 0, 32));
